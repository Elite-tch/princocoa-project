...
export default function CategoryDetail({ category, slug }) {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="pt-20 pb-20 px-6 md:px-12">
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-12 gap-6 md:gap-16 items-start">
                        ...
                        >
                            <span className=" font-bold tracking-[0.4em] uppercase text-[10px] mb-8 block">Domain Expertise</span>
                            <h1 className="text-2xl md:text-7xl font-sans text-gray-950 mb-2 md:mb-4 uppercase leading-[0.9] tracking-tighter">
                                {category.title}
                            </h1>
                            <p className="text-md md:text-2xl text-gray-800 leading-snug max-w-4xl">
            ...
            {/* 3. THE CHALLENGE */}
            <section className="md:py-16 py-8 bg-gray-50 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-12 md:gap-16  gap-6">
                        <div className="md:col-span-4">
                            <h2 className="md:text-3xl text-xl font-sans text-gray-950 uppercase tracking-tight">
                        ...
                        <div className="md:col-span-8">
                            {details.challengeText ? details.challengeText.map((text, i) => (
                                <p key={i} className={`text-md md:text-2xl text-gray-700 leading-relaxed font-light ${i < details.challengeText.length - 1 ? 'md:mb-8 mb-3' : ''}`}>
                                    {text}
                                </p>
                            )) : (
                                <p className="text-md md:text-2xl text-gray-700 leading-relaxed font-light">
            ...
            <section className="md:py-16 py-8 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-24 items-center mb-20">
                        ...
                        >
                            <span className=" font-bold tracking-[0.2em] uppercase text-xs">Phases / 01</span>
                            <h2 className="text-2xl md:text-5xl font-sans text-gray-950 uppercase leading-none">Strategic Focus</h2>
                            {details.approachText ? details.approachText.map((text, i) => (
                                <p key={i} className="text-md md:text-2xl text-gray-600 leading-relaxed font-light">
                                    {text}
                                </p>
                            )) : (
                    ...
                    {/* 5. OUR APPROACH */}
                    <div className="grid md:grid-cols-2 gap-10 md:gap-24 items-center md:mb-20">
                        <motion.div
                            initial={{ opacity: 0, scale: 0.95 }}
                            whileInView={{ opacity: 1, scale: 1 }}
                            viewport={{ once: true }}
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true }}
                            className="md:space-y-5 space-y-2 order-1 md:order-2"
                        >
                            <span className=" font-bold tracking-[0.2em] uppercase text-xs">Phases / 02</span>
                            <h2 className="text-2xl md:text-5xl font-sans text-gray-950 uppercase leading-none">Our Approach</h2>
                            <p className="text-md md:text-2xl font-sans text-gray-950 italic font-light leading-tight">
                    ...
                    <div className="md:py-16 py-10 ">
                        <div className="grid md:grid-cols-12 gap-6 md:gap-16 items-start">
                            ...
                            <div className="md:col-span-8">
                                <p className="text-md md:text-2xl text-gray-900 leading-tight font-sans italic mb-4">
                    ...
                    {/* 7. THE PHILOSOPHY */}
                    <div className="md:py-32 py-10 border-y border-gray-100">
                        <div className="grid md:grid-cols-12 gap-6 md:gap-16 items-start mb-12 md:mb-24">
                            <div className="md:col-span-4">
                            ...
                            <div className="md:col-span-8">
                                <p className="text-lg md:text-4xl font-sans text-gray-900 leading-tight tracking-tight mb-4 uppercase">
                                    {details.philosophyMainTitle || "LIVING IN THE DETAILS AS AN EXTENSION OF YOUR TEAM."}
                                </p>
                                <p className="text-md md:text-xl text-gray-600 leading-relaxed font-light font-sans italic text-gray-500">
