...
export default function BrandBlueprintSection() {
  return (
    <section className="md:py-20 py-10 px-6 bg-pink-600">
      ...
      >
        <h2 className="text-xl md:text-3xl font-bold uppercase text-white  tracking-wider mb-2 text-center ">The Brand Blueprint</h2>

        <p className="md:text-lg text-md text-white mb-2">Agency-level expertise without the monthly retainer</p>

        <p className="md:text-lg text-md text-white mb-10 max-w-3xl mx-auto">
        ...
        <div className="bg-[#39FF14]/80 rounded-2xl p-8 shadow-lg">
          ...
          <p className="text-white md:text-lg text-md mb-6">
