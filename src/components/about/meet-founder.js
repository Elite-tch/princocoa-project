  ...
  return (
    <section className="   py-20 md:py-32">
         ...
         <div className="relative w-[95%] mx-auto">
            ...
            className="relativ  rounded-lg overflow-hidden shadow-xl"
          >
            <div className="absolute z-10  inset-0 mt-[0%] md:mt-[-3%]  overflow-hidden h-[100%] md:h-[100%]">
        <motion.img 
          src="/img2.jpg"
          alt="Background"
          className="absolute rounded-2xl left-0 bottom-[-3.5%] md:top-[0%] h-[200px] md:h-[300px] w-[22%] object-cover pointer-events-none select-none"
        />
      </div>
          ...
          <motion.div
            ...
            className="relativ rounded-lg overflow-hidden shadow-xl w-[2%] order-1 md:order-2"
          >
      ...
      <div className="container relative mx-auto px-6 md:px-12 max-w-7xl">
        ...
        {/* Content Grid */}
        <div className=" mb-16 w-[55%] mx-auto">
          <motion.div
            initial={{ opacity: 0, x: 30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
            className="text-[#004aad]/70 leading-relaxed order-2 md:order-1"
          >
            <p className="text-sm">
